                ...
                <div class="card border-1 shadow-sm">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush small">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <span class="d-inline-flex align-items-center text-body-secondary">
                                    <asset:image src="spring-boot.svg" alt="Spring Boot" width="18" height="18"
                                                 class="me-2"/>
                                    Spring Boot
                                </span>
                ...
                <div class="card border-1 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <g:else>
                                <span class="reload-indicator text-danger" role="status"
                                      aria-label="Reloading inactive">
                                ...
                                <g:each var="row" in="${pluginsWithOrder}">
                                    <g:set var="pluginName"
                                           value="${row.plugin.name
                                                   ...
                                                   .trim()
                                                   .capitalize()}"/>
                                    <tr data-name="${pluginName}" data-version="${row.plugin.version}"
